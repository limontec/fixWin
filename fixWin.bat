...
ECHO [1/7] Verificando integridade da imagem do sistema (DISM)...
DISM /Online /Cleanup-image /Restorehealth
ECHO [2/7] Verificando e reparando arquivos do sistema (sfc)...
sfc /scannow
:: =====================
:: Section 2: Libera espaço ao limpar componentes atualizados. Tempo limite de 1h
ECHO [3/7] Limpando componentes de atualizações antigas...
DISM /online /Cleanup-Image /StartComponentCleanup
:: =====================
:: Section 3: Cria ponto de restauração automático
ECHO [4/7] Limpando pontos de restauração...
vssadmin delete shadows /all /quiet
ECHO [5/7] Criando pontos de restauração...
...
ECHO [7/7] Atualizando programas via winget...
